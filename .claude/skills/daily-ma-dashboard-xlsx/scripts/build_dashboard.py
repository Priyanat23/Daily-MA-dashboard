...
TODAY_DAY = 13          # ลำดับวันที่ปัจจุบัน (11 ก.ค. 2569) ในช่วงข้อมูล 29 มิ.ย.–26 ก.ค. (29 มิ.ย.=1 ... 11 ก.ค.=13)
...
INCENTIVE_ACTUAL = 46.68         # Incentive ประจำวัน (บาท) - Actual (จากชีต 1.Dashboard เซลล์ C4)

# รายได้ของวันที่ทราบ revenue เจาะจง (ปกติคือวันล่าสุด/เมื่อวาน) -> {dayNum: revenue}
DAILY_REVENUE = {12: 211702.0397}
...
DAYS = [
 (1,27,'29 มิ.ย. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-20851.79,ap=0,ar=0,rc=0,so1=0,so2=466.75,pr=0,sv=0,pct=-0.096291)),
 (2,27,'30 มิ.ย. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-24862.39,ap=0,ar=0,rc=0,so1=0,so2=941.23,pr=0,sv=0,pct=-0.112994)),
 (3,27,'1 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-20035.23,ap=0,ar=0,rc=0,so1=0,so2=60.37,pr=0,sv=0,pct=-0.094354)),
 (4,27,'2 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-26264.32,ap=0,ar=0,rc=0,so1=0,so2=216.3,pr=0,sv=0,pct=-0.123041)),
 (5,27,'3 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-22096.89,ap=0,ar=0,rc=0,so1=0,so2=37.558,pr=0,sv=0,pct=-0.1042)),
 ...
 (8,28,'6 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-20115.58,ap=0,ar=0,rc=0,so1=0,so2=1280.26,pr=0,sv=0,pct=-0.088971)),
 (9,28,'7 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-20144.4,ap=0,ar=0,rc=0,so1=510.46,so2=0,pr=0,sv=0,pct=-0.092743)),
 (10,28,'8 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-20742.5,ap=0,ar=0,rc=0,so1=0,so2=162.43,pr=0,sv=0,pct=-0.097212)),
 (11,28,'9 ก.ค. 2569',False, dict(jrts=-24273.8649,ap=76.79918,ar=3.846154,rc=6.704117,so1=4.748597,so2=6.198584,pr=0,sv=0,pct=-0.114196),
                         dict(jrts=-21722.29,ap=0,ar=0,rc=0,so1=0,so2=46.68,pr=0,sv=0,pct=-0.102387)),
...
ANALYSIS_TEXT = dict(
    cause=[
        "JRTS สะสม -196,835.39 บาท เป็นต้นทุนแรงงานหลักที่ดึง Gross MA ติดลบ คิดเป็น 101.93% ของยอด MA ติดลบทั้งหมด (-193,113.35 บาท)",
        "Association Product, Association Refer, Reciprocation ยังไม่มี Actual เข้าระบบเลยตลอด 12 วันแรกของรอบ (0 บาททั้ง 3 ช่องทาง เทียบ Target รวม 921.59+38.46+67.04 บาท)",
        "Shop Online 1+2 สะสม 3,722.04 บาท ดีกว่า Target 131.37 บาท อย่างมีนัยสำคัญ (+3,590.67 บาท หรือ +2,733%)",
    ],
    source=[
        "แผนก PCRC มีพนักงานจำนวนมาก ทำให้ต้นทุน JRTS สูงตามสัดส่วนแรงงาน ยากที่จะลดโดยตรงในระยะสั้น",
        "ข้อมูล Association ยังไม่ถูกบันทึกเข้าระบบ หรือยังไม่มีการโทรติดตามลูกค้าในช่วง 12 วันแรกของรอบนี้",
        "%MA/Revenue สะสม -3.26% ดีกว่า Target -8.15% เนื่องจาก JRTS Actual (-196,835.39) ต่ำกว่า Target (-242,738.65) มาก",
    ],
    solution=[
        "เร่งบันทึก Association Product/Refer/Reciprocation ที่ตกค้าง กระตุ้นทีมให้ครบ Target รวม 87.35 บาท/วัน",
        "ตรวจสอบและบันทึกยอด Actual ของวันที่ 10 กรกฎาคม 2569 ที่ยังไม่เข้าระบบ (ปัจจุบันแสดง 0 บาท) เพื่อความถูกต้องของยอดสะสม",
        "รักษาโมเมนตัม Shop Online ต่อเนื่อง ปัจจุบันสะสม 3,722.04 บาท ให้คงอัตราต่อวันไว้",
    ],
)
